...
//#define USE_PFM_ADDR_MODE 1
#ifndef USE_PFM_ADDR_MODE       //PFM DATA mode
//#define USE_MAX_BUFFER_SIZE 1024*1024
//#define USE_MAX_BUFFER_SIZE (256+64+64+32+128)*1024
#define USE_MAX_BUFFER_SIZE (512+512+384 + 512)*1024
#else
#define USE_MAX_BUFFER_SIZE 128*1024
#endif

#define USE_DIRECT_STREAM_READ 1
...
typedef struct {
	...
	char pids_format[DMX_FILTER_SIZE];
...
extern dvb_config_t *dvb_get_config(char *file_name);
