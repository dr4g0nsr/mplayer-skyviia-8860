                              ...
                              void *opts, int *file_format)
{
    ...
    for (i = 0; i < title_count; i++) {
        ...
        //printf("title idx %u playlist %u duration %llu clips %u angles %u chaps %u\n", ti->idx, ti->playlist, ti->duration, ti->clip_count, ti->angle_count, ti->chapter_count);
...
err_no_info:
    ...
    //s->start_pos   = chapter_pos;	// we can't seek to position smaller than start_pos, don't modify it
