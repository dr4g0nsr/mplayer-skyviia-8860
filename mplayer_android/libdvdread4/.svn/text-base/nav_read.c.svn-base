...
void navRead_PCI(pci_t *pci, unsigned char *buffer) {
  ...
  pci->hli.hl_gi.btn_ofn = getbits(&state, 8 ); //btn_sn?? (starting button number)??
...
//printf("pci->hli.hl_gi.btn_ns[%d]\n",pci->hli.hl_gi.btn_ns);
//  if(pci->hli.hl_gi.btn_ns == 1) // Mantis:5236 LASTMAN.iso
	dvdnav_btn_num = pci->hli.hl_gi.btn_ns;
