...
static const mp_cmd_t mp_cmds[] = {
  ...
  { MP_CMD_GETTHUMB, "getthumb", 1, { {MP_CMD_ARG_STRING, {0}}, {MP_CMD_ARG_INT,{0}}, {-1,{0}} } },
  { MP_CMD_GET_CHAPTER_INFO, "get_chapter_info", 0, { {-1,{0}} } },
  { MP_CMD_GET_CUR_POS_CALLBACK, "get_cur_pos_callback", 1, { {MP_CMD_ARG_INT, {0}}, {-1,{0}} } },
  { MP_CMD_GET_BUFFERING_CALLBACK, "get_buffering_callback", 1, { {MP_CMD_ARG_INT, {0}}, {-1,{0}} } },
  { MP_CMD_GET_AUDIO_INFO, "get_audio_info", 0, { {-1,{0}} } },
  { MP_CMD_GET_SUB_INFO, "get_sub_info", 0, { {-1,{0}} } },
  { MP_CMD_GET_VIDEO_INFO, "get_video_info", 0, { {-1,{0}} } },
  { MP_CMD_GET_TITLE_INFO, "get_title_info", 0, { {-1,{0}} } },
  { MP_CMD_GET_ANGLE_INFO, "get_angle_info", 0, { {-1,{0}} } },
  { MP_CMD_SUB_ON, "sub_on", 1, { {MP_CMD_ARG_INT, {0}}, {-1,{0}} } },
#ifdef CONFIG_RADIO
  ...
  // for reload dvb_conf by carlos 20100804
  { MP_CMD_DVB_LOAD_CONFFILE, "loadconf", 1, { {MP_CMD_ARG_STRING, {0}}, {MP_CMD_ARG_INT,{0}}, {-1,{0}} } },
#ifdef SUPPORT_SKYDVB_DYNAMIC_PID
  { MP_CMD_DVB_STOP_TUNER, "stop_tuner", 1, { {MP_CMD_ARG_INT, {0}}, {-1,{0}} } },
  { MP_CMD_DVB_LOAD_CHANNEL, "skytv", 1, { {MP_CMD_ARG_INT, {0}}, {-1,{0}} } },
  { MP_CMD_DVB_SWITCH, "dvb_switch", 1, { {MP_CMD_ARG_STRING, {0}}, {MP_CMD_ARG_INT,{0}}, {-1,{0}} } },
  ...
  { MP_CMD_SET_SUBCP, "set_subcp", 1, { {MP_CMD_ARG_STRING,{0}}, {-1,{0}} } },	//Fuchun 2010.06.03
  { MP_CMD_AUDIO_SPEED, "audio_speed", 1, { {MP_CMD_ARG_FLOAT,{0}}, {-1,{0}} } },
  { MP_CMD_SUB_COLOR_NUM, "sub_color_num", 1, { {MP_CMD_ARG_INT,{0}}, {-1,{0}} } },

  { MP_CMD_PLAYLIST, "playlist", 0, { {-1,{0}} } },
  { 0, NULL, 0, {} }
};
...
int code_domain = -1;
extern unsigned int ipcdomain;  //for option using
//SkyMedi_Vincent03232010+
...
mp_input_parse_cmd(char* str) {
  ...
  if (pausing == -1) {
    switch (cmd->id) {
      ...
      //Fuchun 20110705 let below commands don't break pause_loop
...
static mp_cmd_t *read_events(int time, int paused)
{
	...
	}else if(time > 0){ // charleslin 20110822 when num_fd is zero, cpu may busy loop in prefill cache stage. force sleep to avoid it
		usleep(time * 1000);
	}
    }
#else
...
//+SkyMedi_Vincent03232010
/*
___________Domain socket control________________()
*/
if(ipcdomain) //using domain socket option
{
	if (code_domain >= 0)
	{
		mp_cmd_t *ret = interpret_key(code_domain, paused);
		code_domain = -1;
    	if (ret)
			return ret;
	}
