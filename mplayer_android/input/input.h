...
typedef enum {
  ...
  MP_CMD_DVB_LOAD_CONFFILE, // for reload dvb_conf by carlos 20100804
  MP_CMD_DVB_STOP_TUNER, /* for enable/disable stop_tuner by mplayer self , add by carlos , 2010-12-27 */
  MP_CMD_DVB_LOAD_CHANNEL, // for load dvb vid, vid_format, aid, aid_format, sid, sid_format, add by carlos 2010-12-14
  MP_CMD_DVB_SWITCH, /*for switch audio/subtitle and format, example : 1:2003:4 ==> Audio:Pid:Mpeg Audio, add by carlos 2011-04-07*/

  /// Console commands
  MP_CMD_CHELP = 7000,
  MP_CMD_CEXIT,
  MP_CMD_CHIDE,
  MP_CMD_GETTHUMB, //SkyViia_Vincent03232010
  MP_CMD_SET_SUBCP,	//Fuchun 2010.06.03
  MP_CMD_AUDIO_SPEED,	//Fuchun 2010.10.29
  MP_CMD_SUB_COLOR_NUM,	//Fuchun 2010.11.11

  MP_CMD_PLAYLIST,
  MP_CMD_GET_CHAPTER_INFO,
  MP_CMD_GET_CUR_POS_CALLBACK,
  MP_CMD_GET_BUFFERING_CALLBACK,
  MP_CMD_GET_AUDIO_INFO,
  MP_CMD_GET_SUB_INFO,
  MP_CMD_GET_VIDEO_INFO,
  MP_CMD_GET_TITLE_INFO,
  MP_CMD_GET_ANGLE_INFO,
