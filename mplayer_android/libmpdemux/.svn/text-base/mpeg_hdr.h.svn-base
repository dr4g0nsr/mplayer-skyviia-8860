...
int h264_parse_sei(unsigned char *buf, int len);	//Fuchun 2010.07.01
int h264_video_sei(unsigned char *buf, int len);	//Barry 2011-12-09
...
int check_avc1_sps_bank0(unsigned char *in_buf, int len);	//Barry 2010-06-17
