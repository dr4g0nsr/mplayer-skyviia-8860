...
//! - DX_ERROR_NOT_AVAILABLE - Not all the bytes could be read and file is not being downloaded.
//! - DX_ERROR_FILE_IS_BEING_DOWNLOADED - Not all the bytes could be read and file is being downloaded.
//! - DX_ERROR_BAD_ARGUMENTS - If drmFile is null.
