...
//! settings. If a previous backup with the same name is already exists it will be overwritten.
//! \param[in] backupName	Optional name of the backup. If NULL is provided a default backup will be created.
//! \return
//! - DX_SUCCESS - Operation completed successfully.
//! - DX_ERROR_SECURE_STORAGE_IS_CORRUPTED - Secure storage is found to be corrupted and cannot be backed up.
//! - DX_ERROR_IPC_FAILURE - Communication with other DRM agent component could not be established.
//! - DX_ERROR_NOT_INITIALIZED - The DRM Client has not been initialized.
//DX_FUNC DRM_C_API EDxDrmStatus DxDrmClient_BackupStorage(const DxChar* backupName);
...
//! \return
//! - DX_SUCCESS - Operation completed successfully.
//! - DX_ERROR_NOT_AVAILABLE - The specified backup could not be found.
//! - DX_ERROR_IPC_FAILURE - Communication with other DRM agent component could not be established.
//! - DX_ERROR_NOT_INITIALIZED - The DRM Client has not been initialized.
//DX_FUNC DRM_C_API EDxDrmStatus DxDrmClient_RestoreStorage(const DxChar* backupName);
