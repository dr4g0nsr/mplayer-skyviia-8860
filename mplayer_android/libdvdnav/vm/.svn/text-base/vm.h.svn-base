...
typedef enum {
  ...
  VTS_DOMAIN  = 2, //Video Title Domain
  VMGM_DOMAIN = 4, //Video Manager Menu Domain
  VTSM_DOMAIN = 8  //Video Title Menu Domain
} domain_t;
...
typedef struct {
  ...
  int       cellN;        /* current chapter number */
...
#endif
  int32_t  cell;          /* cell number */ /* current chapter number */
  int32_t  cell_restart;  /* get cell to restart */
