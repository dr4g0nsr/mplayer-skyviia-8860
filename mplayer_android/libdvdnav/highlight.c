...
#include "../libdvdread4/dvdread/nav_print.h"
...
extern int dvdnav_auto_action;
  ...
  {
//printf("----------------------button_auto_action-----------------------\n");
	dvdnav_auto_action = 1;
...
dvdnav_status_t dvdnav_autoaction_button_select(dvdnav_t *this, pci_t *pci) {
  btni_t *button_ptr;
