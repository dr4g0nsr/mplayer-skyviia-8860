/*!
    @file
@verbatim
$Id: DivXWchar.h 6781 2009-01-14 02:18:31Z fchan $
...
#define wcstok( wcs, delim, ... )       wcstok( wcs, delim )

#else   /*_MSC_VER < 1400*/

#define wcstok( wcs, delim, stat )      wcstok( wcs, delim )
...
#error "COMPILER DETECTION WAS AMBIGUOUS, DON'T KNOW WHICH MACROS TO USE"
