/*!
    @file
@verbatim
$Id: DivXNetFileEx.h 56462 2008-10-13 20:48:09Z jbraness $
...
/*! DNF (DivX Net File) Extended
      
      The DivXNetFileEx provides the same API as DivXNetFile, but provides DivXMem arguments to the 
      function calls.
