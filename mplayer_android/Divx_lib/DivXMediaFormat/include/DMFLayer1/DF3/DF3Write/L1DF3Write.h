...
@file L1DF3Write.h
@verbatim
$Id: L1DF3Write.h 58500 2009-02-18 19:45:46Z jbraness $
...
#ifndef _L1DF3WRITE_H_
#define _L1DF3WRITE_H_
 ...
 */
DivXError L1DF3w_CreateContainer( DF3WriteInstanceHandle *handle,
...
/*!
    ...
    @return The normal return code is DIVX_ERR_SUCCESS
*/
DivXError L1DF3w_EditContainer( DF3WriteInstanceHandle *handle,
                                const DivXString  *filename,
                                DivXMem            hMem );

DivXError L1DF3w_SetTitle(DF3WriteInstanceHandle handle,
                          int32_t           nTitle);
 ...
 */
DivXError L1DF3w_CloseContainer( DF3WriteInstanceHandle handle );
...
/*!
    ...
    @return The normal return code is DIVX_ERR_SUCCESS
 */
DivXError L1DF3w_AddTitle( DF3WriteInstanceHandle handle,
                           int32_t          *TitleID );
...
/*!
    ...
    @return The normal return code is DIVX_ERR_SUCCESS
 */
DivXError L1DF3w_AddMenu( DF3WriteInstanceHandle handle,
...
/*!
    ...
    @return The normal return code is DIVX_ERR_SUCCESS
 */
DivXError L1DF3w_AddMenuMedia( DF3WriteInstanceHandle handle,
                               int32_t          *menuMedia );
...
/*!
    ...
    @return The normal return code is DIVX_ERR_SUCCESS
 */
DivXError L1DF3w_AddStream( DF3WriteInstanceHandle handle,
...
/*!
    ...
    @return The normal return code is DIVX_ERR_SUCCESS
 */
DivXError L1DF3w_AddMenuMediaStream( DF3WriteInstanceHandle ContainerHandle,
                                     DMFBlockType_t    BlockType,
                                     void             *Data,
...
/*!
    ...
    @return The normal return code is DIVX_ERR_SUCCESS
 */
DivXError L1DF3w_WriteNextBlock( DF3WriteInstanceHandle hContainer,
                                 DMFBlockType_t    blockType,
                                 int32_t           nStreamOfType,
...
/*!
    ...
    @return The normal return code is DIVX_ERR_SUCCESS
 */
DivXError L1DF3w_WriteNextMenuMediaBlock( DF3WriteInstanceHandle hContainer,
                                          DMFBlockType_t    blockType,
                                          int32_t           nStream,
                                          DMFBlockNode_t   *pBlockNode );
...
/*!
    ...
    @return The normal return code is DIVX_ERR_SUCCESS
 */
DivXError L1DF3w_FinishTitle( DF3WriteInstanceHandle handle );
...
/*!
    ...
    @return The normal return code is DIVX_ERR_SUCCESS
 */
DivXError L1DF3w_FinishMenuRiff( DF3WriteInstanceHandle handle );
...
/*!
    ...
    @return The normal return code is DIVX_ERR_SUCCESS
 */
DivXError L1DF3w_FinishMRIF( DF3WriteInstanceHandle handle );
...
/*!
    ...
    @return The normal return code is DIVX_ERR_SUCCESS
 */
DivXError L1DF3w_GetInfo( DF3WriteInstanceHandle handle,
...
/*!
    ...
    @return The normal return code is DIVX_ERR_SUCCESS
 */
DivXError L1DF3w_SetInfo( DF3WriteInstanceHandle handle,
                          int32_t           queryValueID,
                          DMFVariant       *inputValue,
                          int32_t           index,
