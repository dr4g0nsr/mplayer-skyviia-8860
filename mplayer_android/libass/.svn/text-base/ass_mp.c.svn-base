...
#ifdef MULTI_LAYER
ass_image_t* ass_mp_render_frame(ass_renderer_t *priv, ass_track_t* track, long long now, int* detect_change, int *num) {
#else
...
#ifdef MULTI_LAYER
	return ass_render_frame(priv, track, now, detect_change, num);
#else
