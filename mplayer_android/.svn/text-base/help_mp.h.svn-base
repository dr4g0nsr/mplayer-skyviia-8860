...
#define MSGTR_OSD_DVB_AUDIO	"Audio: %s"
#define MSGTR_OSD_DVB_SUBTITLE	"Subtitle: %s"
...
#define MSGTR_Unknown_Audio "audio"
#define MSGTR_Unknown_Subtitle "subtitle"
...
#define MSGTR_CantOpenBluray "Couldn't open Bluray device: %s\n"
...
#define MSGTR_BlurayOK "Bluray successfully opened.\n"
