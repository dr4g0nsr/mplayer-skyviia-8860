...
/* Carlos add general debug marco */
#define ENABLE_GLOBAL_DEBUG	/* We need marked this define when we are stable */
#ifdef ENABLE_GLOBAL_DEBUG
#define mplayer_debug(fmt, args...)	printf(fmt, ##args)
#else /* else of ENABLE_GLOBAL_DEBUG */
#define mplayer_debug(fmt, args...)		{}
#endif /* end of ENABLE_GLOBAL_DEBUG */

/* Vincent add dvdnav debug marco */
//#define ENABLE_DVDNAV_DEBUG	/* We need marked this define when we are stable */
#ifdef ENABLE_DVDNAV_DEBUG
#define mplayer_dvdnav_debug(fmt, args...)	printf(fmt, ##args)
#else /* else of ENABLE_DVDNAV_DEBUG */
#define mplayer_dvdnav_debug(fmt, args...)		{}
#endif /* end of ENABLE_DVDNAV_DEBUG */
...
//#define MAX_OUTBURST 65536 //larry 20101117
#define MAX_OUTBURST 65536*3 //larry 20101117 for dtshd
...
#define CONFIGURATION "--host-cc=gcc --target=arm-armv5te-linux --cc=/usr/local/arm/4.3.2/bin/arm-linux-gcc --as=/usr/local/arm/4.3.2/bin/arm-linux-as --ar=/usr/local/arm/4.3.2/bin/arm-linux-ar --ranlib=/usr/local/arm/4.3.2/bin/arm-linux-ranlib --disable-md5sum --disable-pnm --disable-tga --disable-ivtv --disable-v4l2 --disable-libmpeg2 --disable-mp3lib --disable-faad-internal --disable-liba52 --disable-dvdnav --enable-dvdread --enable-dvdread-internal --enable-libdvdcss-internal --disable-mencoder --disable-tv --disable-xanim --disable-win32dll --disable-termcap --disable-dynamic-plugins --disable-libpostproc_a --disable-libpostproc_so"
...
#define HAVE_RTC 1
#ifdef BUILD_C000000_UNUSED_CODEC	//Barry 2011-10-06
...
#undef ALSA_ENABLE //Ethan Lin 2010/10/28

#ifdef ALSA_ENABLE
#define CONFIG_ALSA
#define CONFIG_ALSA1X
#else
#undef CONFIG_ALSA
#undef CONFIG_ALSA1X
#endif
...
/* Carlos add for qt support dvbt */
#define QT_SUPPORT_DVBT
...
#define CONFIG_BITMAP_FONT 0
#undef CONFIG_ENCA
#undef CONFIG_FONTCONFIG
#define CONFIG_FREETYPE

#ifdef FRIBIDI_ENABLE
...
#undef CONFIG_ZR
/* Carlos add macro for debug time, 2011-06-22 */
//#define DEBUG_TIMER
#ifdef DEBUG_TIMER
#define ANNOUNCE_VALUE(a);     unsigned int a = 0;
#define SET_TIME(a);   { a = GetTimer();}
#define PRINT_TIME(a, show);    {       \
	a = (GetTimer() - a) / 1000;    \
	printf("@@@@ In [%s][%d] do [%s] cost [%3d] ms @@@\n", __func__, __LINE__, show, a);    \
}
#else /* else of DEBUG_TIMER */
#define ANNOUNCE_VALUE(a);     {}
#define SET_TIME(a);   {}
#define PRINT_TIME(a, show);   {}
#endif /* end of DEBUG_TIMER */
// Carlos 20100519
#define HW_TS_DEMUX	1
// Carlos 2010-07-27
#define HWTS_USED_FRAMEBUFFER	1
/* Debug pts only */
#define DEBUG_ADD_PACKET_PTS
#ifdef QT_SUPPORT_DVBT
/* Carlos  for DVB-T, change process */
#define DVBT_USING_NORMAL_METHOD
/* Carlos add for DVB-T, new load vid/aid/sid */
#define SUPPORT_SKYDVB_DYNAMIC_PID
#endif /* end of QT_SUPPORT_DVBT */
/* Carlos add for QT 128MB, fine-tune BD-ISO , 2010-12-31 */
#define SUPPORT_QT_BD_ISO_ENHANCE
/* Carlos add for enable HWTS when source is networking, 2011-01-18 */
#define SUPPORT_NETWORKING_HWTS
/* Carlos add for select other audio stream except DTS, 2011-01-18 */
#define SUPPORT_TS_SELECT_LOW_AUDIO
/* Carlos add for dynamical change ts detect buffer size, 2011-03-15, range is 0x1000 ~ 0x800000 */
#define TS_STREAM_CHECK_RANGE
...
//#define DEMUX_AUTO
#define DS_WAKEUP
//#define WAIT_FULL_FIRST
//#define STATISTICAL_THRESHOLD
//#define ADAPTIVE_THRESHOLD
#endif
#define STREAM_BUF_PTR
#ifdef STREAM_BUF_PTR
#define STREAM_NI
#define STREAM_DIO
#ifdef STREAM_DIO
#define STREAM_DIO_AUTO
#endif
#define STREAM_AIO
#ifdef STREAM_AIO
#define STREAM_AIO_AUTO
#define STREAM_USE_DEVMEM
#endif
#endif
//#define XFER_SPEED
#ifdef XFER_SPEED
#define READ_PERF_TEST
#endif
#ifdef BUILD_C000000_UNUSED_CODEC	//Barry 2011-10-06
//#define CACHE_IN_FILE        // download whole stream to file
#undef CACHE_IN_FILE
//#define YOUTUBE_RECONNECT // reconnect to youtube if download not complete
#undef YOUTUBE_RECONNECT
#undef DTS_CERTIFICATION
#else
#define CACHE_IN_FILE	// download whole stream to file
#define YOUTUBE_RECONNECT // reconnect to youtube if download not complete
#define DTS_CERTIFICATION
#endif
#define FILE_CACHE	// use file as cache space
#define VMEM_CACHE	// use video memory as cache space
#define FIX_PGSSUB_DELAY
//#define FIX_SUBTITLE_FLICKING
//#define FIX_RMVB_FLICKING
#define BITSTREAM_BUFFER_CONTROL

#define CMV_WORKAROUND

#define VO_SUB_THREAD	//Robert 20101029 new pthread for draw_osd
#define FT_BITMAP_CACHE_OFF

#define SWITCH_AUDIO_THREAD	//Barry 2011-02-17 pthread for switch_audio
#define BD_CLIP_BASE_PTS	//Barry 2011-02-17
//#define REAL_NO_INDEX_SEEK	//Barry 2011-03-14

#define DVB_SUBTITLES	//Fuchun 2010.09.28
#ifdef DVB_SUBTITLES
#define AVI_SUBTITLES
#define DVB_TRUE_COLOR
#endif
#define MULTI_LAYER
#define AVI_NOT_SORT	//Fuchun 2011.03.01
#define FAST_SPEED 6
#define PARSE_REAL_CHANNELS


#define SKY_HTTP /* leochang 20110424 */ 
...
#define CONFIG_PGSSUB_DECODER 1
#define CONFIG_XSUB_DECODER 1
#endif //end #ifndef BUILD_MPLAYER_LITE
...
/* WT, 100712, open DRM */
#undef CONFIG_DRM_ENABLE 
#define CONFIG_DVDNAV_MAIN2 1
//#define CONFIG_DEBUG_AVSYNC 1
