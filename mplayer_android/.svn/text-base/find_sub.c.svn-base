...
update:
	...
	if(new_sub != NULL && sub_temp_utf8 == 2) new_sub = subcp_recode(new_sub);
	if(new_sub == NULL) clear_osd();
#endif
#ifdef CONFIG_FRIBIDI
	if(new_sub != NULL && sub_temp_utf8 == 2 && (sub_cp && !strncasecmp(sub_cp, "cp1256", 6))) new_sub=sub_fribidi(new_sub,sub_utf8,0);
#endif
