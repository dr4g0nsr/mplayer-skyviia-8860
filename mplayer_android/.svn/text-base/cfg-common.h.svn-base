...
//Fuchun 2010.12.28
const m_option_t subopt[]={
	{"cp", &sub_cp, CONF_TYPE_STRING, 0, 0, 0, NULL},
	{"delay", &sub_delay, CONF_TYPE_FLOAT, 0, 0.0, 100.0, NULL},
	{"scale", &text_font_scale_factor, CONF_TYPE_FLOAT, CONF_RANGE, 2, 5, NULL},
	{"pos", &sub_pos, CONF_TYPE_INT, CONF_RANGE, 0, 100, NULL},
	{"color", &color_num, CONF_TYPE_INT, CONF_RANGE, 0, 7, NULL},
	{NULL, NULL, 0, 0, 0, 0, NULL}
};
