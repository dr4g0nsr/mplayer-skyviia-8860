...
// ------------------------- stream options --------------------
	...
	{"bluray-angle", &bluray_angle, CONF_TYPE_INT, CONF_RANGE, 1, 99, NULL},
	{"bluray-chapter", &bluray_chapter, CONF_TYPE_INT, CONF_RANGE, 1, 99, NULL},
	{"bluray-title", &bluray_title, CONF_TYPE_INT, CONF_RANGE, 0, 99999, NULL},
	{"bluray-m2ts", &bluray_m2ts, CONF_TYPE_INT, CONF_RANGE, 0, 99999, NULL},
#else
	...
	{"tcp-timeout", &network_timeout, CONF_TYPE_INT, CONF_RANGE, 0, 65535, NULL},
...
#if defined(CONFIG_NETWORK) && defined(NATIVE_RTSP)
...
#define TS_MAX_PROBE_SIZE 6000000 /* do not forget to change this in libmpdemux/demux_ts.c too */
